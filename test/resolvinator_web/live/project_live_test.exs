defmodule ResolvinatorWeb.ProjectLiveTest do
  use ResolvinatorWeb.ConnCase

  import Phoenix.LiveViewTest
  import Resolvinator.ProjectsFixtures

  @create_attrs %{name: "some name", status: "some status", description: "some description", risk_appetite: "some risk_appetite", start_date: "2024-10-29", target_date: "2024-10-29", completion_date: "2024-10-29", settings: %{}}
  @update_attrs %{name: "some updated name", status: "some updated status", description: "some updated description", risk_appetite: "some updated risk_appetite", start_date: "2024-10-30", target_date: "2024-10-30", completion_date: "2024-10-30", settings: %{}}
