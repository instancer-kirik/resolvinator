    ...
    case Projects.get_project_by_name("Mathematics Learning Platform") do
      nil ->
        {:ok, project} = Projects.create_project(%{
          ...
          descr: "A platform for learning advanced mathematics concepts",
          status: "active",
    ...
    if project do
      ...
      Seeds.Helper.safe_run "mathematical content", fn ->
        ...
        {:ok, question} = Repo.insert(%Question{
          ...
          description: "Provide a geometric proof of the Pythagorean Theorem",
        ...
        {:ok, answer} = Repo.insert(%Answer{
          ...
          description: "A proof using area comparison of squares",
          answer_type: "proof",
        ...
        {:ok, problem} = Seeds.Helper.safe_run "problem", fn ->
          ...
          {:ok, prob} = Repo.insert(%Problem{
            ...
            description: "Calculate the length of a right triangle's hypotenuse",
            creator_id: admin.id,
            project_id: project.id,
            status: "published",
            impacts: [
              %{
                ...
                notes: "Common issue in engineering calculations"
              }
            ]
          })
        ...
        {:ok, solution} = Seeds.Helper.safe_run "solution", fn ->
          ...
          Repo.insert(%Solution{
            ...
            description: "Apply a² + b² = c² to find the missing side",
            creator_id: admin.id,
            project_id: project.id,
            status: "published"
          })
        ...
        # Assuming you have a section where you create the lesson
        lesson = Seeds.Helper.safe_run "lesson", fn ->
          Repo.insert(%Lesson{
            name: "Introduction to Geometry",
            description: "A basic lesson on geometric principles.",
            creator_id: admin.id,
            project_id: project.id,
            status: "published"
          })
        ...
        # Ensure lesson is not nil before using it
        if lesson do
        ...
        # Assuming you have a section where you create the advantage
        advantage = Seeds.Helper.safe_run "advantage", fn ->
          Repo.insert(%Advantage{
            name: "Understanding the Pythagorean Theorem",
            description: "A detailed explanation of the theorem's applications.",
            creator_id: admin.id,
            project_id: project.id,
            status: "published"
          })
        ...
        # Ensure advantage is not nil before using it
        if advantage do
          ...
          IO.puts("Advantage creation failed.")
        end
