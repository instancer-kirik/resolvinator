defmodule Resolvinator.Repo.Migrations.SetupResolvinatorActsFdw do
  use Ecto.Migration
  ...
  def up do
    ...
    execute "CREATE SCHEMA IF NOT EXISTS resolvinator_acts_fdw;"
  ...
  def down do
    execute "DROP SCHEMA IF EXISTS resolvinator_acts_fdw CASCADE;"
