defmodule Resolvinator.Accounts do
  ...
  alias Resolvinator.Accounts.{User, UserToken, UserNotifier}
  ...
  def ban_user(%User{} = user) do
    user
    |> User.ban_changeset(%{banned_at: DateTime.utc_now()})
    |> Repo.update()
  end
  ...
  defp filter_banned_users(query) do
    from u in query, where: is_nil(u.banned_at)
  end
