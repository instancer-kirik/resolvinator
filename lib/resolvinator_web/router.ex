defmodule ResolvinatorWeb.Router do
  ...
  scope "/resolvinator" do
    ...
    live "/", ResolvinatorWeb.DashboardLive, :index
    live "/resolvinator", ResolvinatorWeb.ResolveLive, :index
    live "/history", ResolvinatorWeb.HistoryLive, :index
    live "/settings", ResolvinatorWeb.SettingsLive, :edit
  end
